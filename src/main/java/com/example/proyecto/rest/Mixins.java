...
//		
	...
	@JsonPropertyOrder({ "id", "fechaInicio", "fechaFin", "activo", "usuario", "reservaAprobada"})
...
//		
	...
	@JsonPropertyOrder({ "id", "numeroTelefono", "correo", "usuarioReservas", "activos"})
...
//		
	...
	@JsonPropertyOrder({ "id", "tipo", "capacidad", "nombreAula", "proyector", "marca", "usuario"})
//	@JsonIgnoreProperties(value = { "fechaIngresoFas" })
